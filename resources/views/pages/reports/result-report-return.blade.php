                ...
                <div class="col-12 col-lg-10 col-xl-9">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="page-title">Laporan Pengembalian</h4>
                        </div>
                        <div class="col-auto">
                            ...
                            <div class="card card-invoice">
                                        ...
                                        <div class="col-md-12">
                                            <div class="invoice-detail">
                                                <div class="invoice-top mb-4 text-center">
                                                    <h3 class="title"><strong>Laporan Data Pengembalian</strong></h3>
                                                </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <p class="text-muted text-justify mb-0">
                                        Laporan ini menyajikan informasi tentang buku yang telah dikembalikan oleh anggota, termasuk keterlambatan pengembalian.Catatan ini penting untuk menilai kedisiplinan anggota dalam mengikuti aturan peminjaman serta menjadi dasar pengenaan denda bila diperlukan.
                                    </p>
                                </div>
                            </div>
                        </div>
