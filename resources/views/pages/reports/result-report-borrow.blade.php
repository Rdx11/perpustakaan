                            ...
                            <div class="card card-invoice">
                                        ...
                                        <div class="col-md-12">
                                            <div class="invoice-detail">
                                                <div class="invoice-top mb-4 text-center">
                                                    <h3 class="title"><strong>Laporan Data Peminjam</strong></h3>
                                                </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <p class="text-muted mb-0 text-justify">
                                        Laporan peminjaman mencatat seluruh aktivitas peminjaman buku selama periode tertentu.Data ini meliputi frekuensi peminjaman, jenis buku yang paling sering dipinjam, dan jumlah anggota yang melakukan transaksi.Laporan ini berguna untuk mengetahui kebutuhan pengguna dan tren minat baca.
                                    </p>
                                </div>
                            </div>
                        </div>
