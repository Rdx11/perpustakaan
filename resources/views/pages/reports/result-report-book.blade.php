                ...
                <div class="col-12 col-lg-10 col-xl-9">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h4 class="page-title">Laporan Buku</h4>
                        </div>
                        <div class="col-auto">
                            ...
                            <div class="card card-invoice">
                                        ...
                                        <div class="col-md-12">
                                            <div class="invoice-detail">
                                                <div class="invoice-top mb-4 text-center">
                                                    <h3 class="title"><strong>Laporan Keadaan Buku</strong></h3>
                                                </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <p class="text-muted text-justify mb-0">
                                        Data buku dalam laporan ini diperoleh dari hasil inventarisasi fisik koleksi perpustakaan.Informasi meliputi jumlah judul, jumlah eksemplar, dan kondisi buku (baik, rusak ringan, rusak berat, hilang).Laporan ini bertujuan memberikan gambaran kondisi aktual koleksi dan menjadi dasar untuk perawatan atau pengadaan lanjutan.
                                    </p>
                                </div>
                            </div>
                        </div>
