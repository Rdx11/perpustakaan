                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="email2">No Pinjam</label>
                                        <input type="email" class="form-control" id="email2" placeholder="No Pinjam">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="email2" placeholder="Jumlah">
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">No Anggota</label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Kode Buku</label>
                                        <select class="form-control" id="exampleFormControlSelect1">
