        ...
        <div class="sidebar-content">
            <ul class="nav nav-primary">
                ...
                <li class="nav-section">
                    ...
                    <h4 class="text-section">Keanggotaan</h4>
                </li>
                <li class="nav-item">
                    <a data-toggle="collapse" href="#pelajar">
                        <i class="fas fa-address-card"></i>
                        <p>Pelajar</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse" id="pelajar">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="components/avatars.html">
                                    <span class="sub-item">List Anggota Pelajar</span>
                                </a>
                            </li>
                            <li>
                                <a href="components/buttons.html">
                                    <span class="sub-item">Tambah Anggota Pelajar</span>
                                </a>
                            </li>
                        </ul>
                    </div>
